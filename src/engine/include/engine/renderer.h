...
public:
    ...
    virtual void setClipEllipses(const std::vector<engine::Types::Ellipse>& dst) = 0;
    virtual void setClipEllipsesScreen(const std::vector<engine::Types::Ellipse>& dst, const engine::Types::Rect<>& rc) = 0;
