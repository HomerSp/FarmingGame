...
public:
    ...
    std::unique_ptr<engine::graphics::ShaderProgram> createShader(const std::string& vertexFile, const std::string& fragmentFile) const override;
...
private:
    ...
    std::unique_ptr<engine::graphics::ShaderProgram> mTexture2DShader, mTextureAnim2DShader;
    std::unique_ptr<engine::graphics::ShaderProgram> mPointLightShader;
    std::unique_ptr<engine::graphics::ShaderProgram> mColorShader;
    std::unique_ptr<engine::graphics::ShaderProgram> mParticle2DShader;
    std::unique_ptr<engine::graphics::ShaderProgram> mFBO2DShader;
    ...
    std::unique_ptr<engine::graphics::Texture> mTestTexture;
};
